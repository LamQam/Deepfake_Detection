...
MODEL_PATH = "ultra_deepfake_model.keras"
...
def plot_confusion_matrix(y_true, y_pred, save_path="xception_confusion_matrix.png"):
...
def plot_roc_curve(y_true, y_pred_proba, save_path="xception_roc_curve.png"):
    ...
    plt.title('ROC Curve - xception on WildDeepfake Dataset')
...
def plot_prediction_distribution(y_true, y_pred_proba, save_path="xception_prediction_distribution.png"):
    ...
    plt.title(
        'Distribution of Prediction Probabilities\nxception on WildDeepfake Dataset')
    plt.legend()
    plt.grid(True, alpha=0.3)
...
def main():
    ...
    print("="*80)
    print("xception MODEL EVALUATION ON WILDDEEPFAKE DATASET")
    print("="*80)
    ...
    print("="*80)
    print(f"Model: xception (WildDeepfake Fine-tuned)")
    ...
    with open('xception_evaluation_results.txt', 'w') as f:
        f.write("xception WildDeepfake Evaluation Results\n")
        f.write("="*50 + "\n")
    ...
    print(f"📝 Results summary saved to: xception_evaluation_results.txt")
    print("="*80)
