...
def load_and_evaluate_model(model_path, test_generator):
    ...
    print("Loading trained ResNet152 model...")
    try:
...
def plot_confusion_matrix(y_true, y_pred, save_path="resnet152_confusion_matrix.png"):
...
def plot_roc_curve(y_true, y_pred_proba, save_path="resnet152_roc_curve.png"):
    ...
    plt.title('ROC Curve - ResNet152 on WildDeepfake Dataset')
...
def plot_prediction_distribution(y_true, y_pred_proba, save_path="resnet152_prediction_distribution.png"):
    ...
    plt.title(
        'Distribution of Prediction Probabilities\nResNet152 on WildDeepfake Dataset')
    plt.legend()
    plt.grid(True, alpha=0.3)
...
def main():
    ...
    print("="*80)
    print("RESNET152 MODEL EVALUATION ON WILDDEEPFAKE DATASET")
    print("="*80)
    ...
    print("="*80)
    print(f"Model: ResNet152 (WildDeepfake Fine-tuned)")
    ...
    with open('resnet152_evaluation_results.txt', 'w') as f:
        f.write("ResNet152 WildDeepfake Evaluation Results\n")
        f.write("="*50 + "\n")
    ...
    print(f"📝 Results summary saved to: resnet152_evaluation_results.txt")
    print("="*80)
